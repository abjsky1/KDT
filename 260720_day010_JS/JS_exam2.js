/*예제 1: 기본 함수 선언 및 호출
'함수 호출 성공!'이라는 메시지를 콘솔에 출력하는 sayHello 라는 이름의 함수를 정의하고, 
그 함수를 호출하시오.*/
...
//     console.log(`환영합니다, ${이름}님!`)
//     return
// }
// getWelcomeMessage(prompt(`이름 입력`))


// function getWelcomeMessage(이름){
//     return `환영합니다, ${이름}님!`
// }
// let 결과 = getWelcomeMessage(김길리)
// 
// console.log (결과)
...
//     }
// }
// printNumbers(Number(prompt(`숫자 입력`)))
...
// }
// 
// let 결과 = isPositive(Number(prompt(`숫자 입력`)))
// console.log(결과)
...
// }
// 
// console.log(isPositive(Number(prompt(`숫자 입력`))))
...
두 변수를 모두 콘솔에 출력해 보세요. 
함수 바깥에서는 globalText만 출력되는 것을 확인하세요.  */
