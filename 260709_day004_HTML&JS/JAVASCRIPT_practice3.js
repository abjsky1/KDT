...
let a = prompt(`과일 입력`)
if(a == fruitList[0] || a == fruitList[1]){console.log(`이미 존재하는 과일입니다.`)}
else{fruitList.push(a); console.log(fruitList)}
...
let a = parseInt(prompt(`월(Month) 입력`))

if(a >= 3 && a < 6 ){console.log(`봄`)}
else if(a >= 6 && a < 9 ){console.log(`여름`)}
else if(a >= 9 && a < 12 ){console.log(`가을`)}
else if(a == 12 || a == 1 || a == 2 ){console.log(`겨울`)}
...
let 연도입력 = parseInt(prompt(`연도 입력`))

if((연도입력 % 4 == 0 && 연도입력 % 100 != 0) || (연도입력 & 400 == 0)){
    console.log(`${연도입력}년은 윤년입니다.`)
}
else{console.log(`${연도입력}년은 평년입니다.`)}
...
if(차량번호 == carArray[0]){
    console.log(`${차량번호} 차량의 주차 위치는 ${locationArray[0]} 입니다.`)
}
else if(차량번호 == carArray[1]){
    console.log(`${차량번호} 차량의 주차 위치는 ${locationArray[1]} 입니다.`)
}
else if(차량번호 == carArray[2]){
    console.log(`${차량번호} 차량의 주차 위치는 ${locationArray[2]} 입니다.`)
}
...
let 제외과목명 = prompt(`제외하고 싶은 과목명을 입력하세요`)

for(let i = 0 ; i <= courseList.length-1 ; i++){
    if(제외과목명 == courseList[i]){
